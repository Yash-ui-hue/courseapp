...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try { await API.post('/auth/register',form); navigate('/dashboard'); }
    ...
    <div style={{
      ...
      <div style={{width:'100%',maxWidth:380}}>
        ...
        <div className="fade-up" style={{textAlign:'center',marginBottom:'1.75rem'}}>
          ...
          <h1 style={{fontSize:'1.3rem',marginBottom:5}}>Create an account</h1>
        ...
        <div className="fade-up-1 card" style={{padding:'1.5rem'}}>
          ...
          <p style={{textAlign:'center',color:'var(--muted)',fontSize:13}}>
            ...
            <Link to="/login" style={{color:'var(--text)',fontWeight:600,textDecoration:'none'}}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
