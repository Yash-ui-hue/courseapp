...
export default function Dashboard() {
  ...
  return (
    <div className="page">
      <DesktopNavbar navigate={navigate} location={location} theme={theme} toggle={toggle} />      <div className="page-content">
        {kycStatus === 'success' && (
...
function DesktopNavbar({ navigate, location, theme, toggle }) {
